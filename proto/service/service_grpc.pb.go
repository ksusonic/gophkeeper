...
func (c *secretServiceClient) GetAllSecrets(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetAllSecretsResponse, error) {
...
func (UnimplementedSecretServiceServer) GetAllSecrets(context.Context, *emptypb.Empty) (*GetAllSecretsResponse, error) {
...
func _SecretService_GetAllSecrets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SecretServiceServer).GetAllSecrets(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
