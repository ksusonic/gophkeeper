...
func (x *Secret) GetAuthData() *AuthenticationData {
	if x, ok := x.GetValue().(*Secret_AuthData); ok {
		return x.AuthData
	}
	return nil
}
...
func (x *Secret) GetText() string {
	if x, ok := x.GetValue().(*Secret_Text); ok {
		return x.Text
	}
	return ""
}

func (x *Secret) GetAny() *anypb.Any {
	if x, ok := x.GetValue().(*Secret_Any); ok {
		return x.Any
	}
	return nil
}

func (x *Secret) GetCreditCardData() *CreditCardData {
	if x, ok := x.GetValue().(*Secret_CreditCardData); ok {
...
type Secret_AuthData struct {
	AuthData *AuthenticationData `protobuf:"bytes,11,opt,name=AuthData,json=authentication_data,proto3,oneof"`
}
...
type Secret_Any struct {
	Any *anypb.Any `protobuf:"bytes,13,opt,name=Any,json=any,proto3,oneof"`
}

type Secret_CreditCardData struct {
	CreditCardData *CreditCardData `protobuf:"bytes,14,opt,name=CreditCardData,json=credit_card_data,proto3,oneof"`
}

func (*Secret_AuthData) isSecret_Value() {}

func (*Secret_Text) isSecret_Value() {}

func (*Secret_Any) isSecret_Value() {}

func (*Secret_CreditCardData) isSecret_Value() {}
...
var file_proto_data_secret_proto_rawDesc = []byte{
	...
	0x2f, 0x61, 0x6e, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9b, 0x02, 0x0a, 0x06, 0x53,
	...
	,
...
var file_proto_data_secret_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
var file_proto_data_secret_proto_depIdxs = []int32{
	3, // 0: secret.Secret.Meta:type_name -> google.protobuf.Struct
	1, // 1: secret.Secret.AuthData:type_name -> secret.AuthenticationData
	4, // 2: secret.Secret.Any:type_name -> google.protobuf.Any
	2, // 3: secret.Secret.CreditCardData:type_name -> secret.CreditCardData
...
func file_proto_data_secret_proto_init() {
	...
	file_proto_data_secret_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*Secret_AuthData)(nil),
		(*Secret_Text)(nil),
		(*Secret_Any)(nil),
		(*Secret_CreditCardData)(nil),
	}
	type x struct{}
